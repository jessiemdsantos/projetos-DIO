...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":name":{"S":"Wings"}}'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":v_artist":{"S":"BTS"},":v_title":{"S":"Wings"} }'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":v_song":{"S":"Blood Sweat & Tears"},":v_year":{"S":"2016"} }'
```
